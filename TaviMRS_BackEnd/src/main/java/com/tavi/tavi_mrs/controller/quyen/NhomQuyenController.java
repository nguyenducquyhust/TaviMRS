...
public class NhomQuyenController {
    ...
    public ResponseEntity<JsonResult> findById(@RequestParam("id") int idNhomQuyen) {
        return nhomQuyenService.findByIdNhomQuyen(idNhomQuyen)
    ...
    @PutMapping("/update")
    public ResponseEntity<JsonResult> update(@Valid @RequestBody NhomQuyen nhomQuyen) {
        return nhomQuyenService.save(nhomQuyen)
