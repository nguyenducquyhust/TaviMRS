...
public class QuyenController {
    ...
    public ResponseEntity<JsonResult> findById(@RequestParam("id") int idQuyen) {
        return quyenService.findByIdQuyen(idQuyen)
    ...
    @PutMapping("/update")
    public ResponseEntity<JsonResult> update(@Valid @RequestBody Quyen quyen) {
        return quyenService.save(quyen)
